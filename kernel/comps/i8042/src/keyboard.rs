...
pub(super) fn dispatch_keyboard_input() {
    ...
    if let Some(key_code) = scancode_event.to_key_code() {
        ...
        // Detect Alt+F1–F12 (virtual terminal switching) and
        // Ctrl+Alt+F1–F12 (spawn new console).
...
const fn translate_set2_to_set1(set2: u8) -> u8 {
    // Reference: <https://elixir.bootlin.com/linux/v6.18/source/drivers/input/keyboard/atkbd.c#L125>
